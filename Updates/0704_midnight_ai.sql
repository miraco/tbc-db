...
(1555001, 'Karazhan - Attument the Huntsman - Phase 2', 0, 0),
(1615101, 'Karazhan - Midnight - Phase 1', 0, 0),
(1615102, 'Karazhan - Midnight - Phase 2', 0, 0),
(1615201, 'Karazhan - Attument the Huntsman - Phase 3 - Mounted', 0, 0);
...
-- Attument the Huntsman Mounted (Phase 3)
(1615201, 1, 29833, 0, -1, 2, 0, 100, 0, 30000, 30000, 30000, 30000, 'Attument the Huntsman - Intangible Presence - self'),
(1615201, 2, 29847, 0, -1, 101, 0, 100, 0, 20000, 20000, 12000, 20000, 'Attument the Huntsman - Charge - random not tank'),
(1615201, 3, 29711, 0, -1, 1, 0, 100, 0, 6000, 9000, 22000, 30000, 'Attument the Huntsman - Knockdown - current'),
(1615201, 4, 29832, 0, -1, 1, 0, 100, 0, 10000, 16000, 22000, 30000, 'Attument the Huntsman - Shadow Cleave - current');
